...
import static ru.clevertec.bill.parser.JsonConstants.*;
...
public class CustomJsonParserImpl implements CustomJsonParser {
    ...
    public String parseToJson(Object object) throws IllegalAccessException {
        ...
        switch (className) {
            case STRING, CHARACTER, CHARACTER_PRIMITIVE -> {
                builder.append(QUOTES).append(object).append(QUOTES);
                return builder.toString();
            }
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (value != null) {
                builder.append(QUOTES).append(name).append(QUOTES)
                        .append(COLON);
    ...
    private void appendMap(StringBuilder builder, Object value) throws IllegalAccessException {
        ...
        for (int i = 0; i < keysArray.length; i++) {
            builder.append(QUOTES).append(keysArray[i]).append(QUOTES)
                    .append(COLON);
    ...
    private void appendObjectArray(StringBuilder builder, Object value) throws IllegalAccessException {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            switch (className) {
                case STRING, CHARACTER, CHARACTER_PRIMITIVE -> builder.append(QUOTES).append(array[i]).append(QUOTES);
                case BYTE, BYTE_PRIMITIVE, SHORT, SHORT_PRIMITIVE,
                        INTEGER, INTEGER_PRIMITIVE, LONG, LONG_PRIMITIVE,
                        FLOAT, FLOAT_PRIMITIVE, DOUBLE, DOUBLE_PRIMITIVE,
    ...
    private void fillValues(StringBuilder builder, Object value) throws IllegalAccessException {
        if (value.getClass().isEnum()) {
            builder.append(QUOTES).append(value).append(QUOTES);
            ...
            switch (value.getClass().getSimpleName()) {
                case STRING, CHARACTER, CHARACTER_PRIMITIVE -> builder.append(QUOTES).append(value).append(QUOTES);
                case BYTE, BYTE_PRIMITIVE, SHORT, SHORT_PRIMITIVE,
                        INTEGER, INTEGER_PRIMITIVE, LONG, LONG_PRIMITIVE,
                        FLOAT, FLOAT_PRIMITIVE, DOUBLE, DOUBLE_PRIMITIVE,
                        BOOLEAN, BOOLEAN_PRIMITIVE -> builder.append(value);
