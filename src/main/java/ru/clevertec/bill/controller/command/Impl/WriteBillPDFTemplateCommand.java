...
public class WriteBillPDFTemplateCommand implements Command {
    @Override
    public Router execute(HttpServletRequest request) {
        ...
        ByteArrayOutputStream bill = billConfigurator.configurePDFBill(purchases, cardDiscount,
                cardDiscountPercent, promoDiscount, totalForPay, date);
        if (BillPDFWriter.writeBillTemplatePDF(bill)) {
